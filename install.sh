...
if [ ! -f installer/install/tpot.yml ] && [ ! -f tpot.yml ];
  then
    ...
    wget -qO tpot.yml https://raw.githubusercontent.com/CSIRT-ANACOM/tpotce/refs/heads/master/installer/install/tpot.yml?token=GHSAT0AAAAAACXO5Z3VHE7JBNBMIYXWPC5QZYDY7LA
